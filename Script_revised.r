...
beltdata <- read_xlsx("Riparian works monitoring data_20231013.xlsx", sheet = "Belt transect counts")
heightdata <- read_xlsx("Riparian works monitoring data_20231013.xlsx", sheet = "Tree Heights")
dbhdata <- read_xlsx("Riparian works monitoring data_20231013.xlsx", sheet = "DBH")
stratadata<- read_xlsx("Riparian works monitoring data_20231013.xlsx", sheet = "Strata Heights")
canopydata <- read_xlsx("Riparian works monitoring data_20231013.xlsx", sheet = "Canopy")
quadratdata <- read_xlsx("Riparian works monitoring data_20231013.xlsx", sheet = "1m quadrat")
